    ...
    .userIndice {
        ...
        ul {
            ...
            li {
                ...
                background-color: lighten($color: $backgroundColor, $amount: 2%);
                border: 2px solid $whiteBorderColor;
                transition: background-color 0.2s cubic-bezier(0.075, 0.82, 0.165, 1);

                &:hover {
                    cursor: pointer;
                    background-color: lighten($color: lighten($color: $backgroundColor, $amount: 2%), $amount: 5%);
                }
            }
        }
    }
    ...
    .userProfile {
        ...
        .userImage {
            ...
            svg {
                ...
                border-radius: 50%;
                border: 2px solid lighten($color: #000000, $amount: 20%);
            }
        }
        ...
        .experiencePoints {
            ...
            progress {
                ...
                &::-webkit-progress-value {
                    ...
                    box-shadow:  0 0 40px darken($color: $textColor, $amount: 30%);
                }
            }
        }
    }
