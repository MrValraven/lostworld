<template>
  ...
  <section class="hero">
    ...
    <div class="heroContent">
      <h1>Lost World Comics</h1>
      <p>On the verge of a dark canyon, an arcane force pulls you towards a mysterious portal.<br> Are you ready to delve into the mystical lands of the <span>Lost World</span>?</p>
      <a class="morphing-5"> Enter the Portal </a>
    </div>
  </section>
  <section class="advice">
    ...
    <div class="message">
      ...
      <div class="classes">
        ...
        <img src="@/assets/skill5.svg" alt="">
      </div>
    </div>
  </section>
  <section class="info">
    <div class="infoImage">
      <img src="@/assets/fantasticLandscape.jpg" alt="">
    </div>
    <div class="infoImage2">
      <img src="@/assets/fantasticLandscape.jpg" alt="">
    </div>
  ...
  <section class="comics">
    <img src="@/assets/courtOfOwls.jpg" alt="">
    <div>
      <h1>Court of Owls buys its comics at <span class="lostworld">Lost World!</span></h1>
      <p> Immerse yourself in marvel , dc , conan , saga, invincible</p>
...
.hero {
  ...
  .heroImage {
    ...
    // blurred gradient at the bottom of hero image
    &::before {
      content: '';
      position: absolute;
      bottom: 0;
      width: 100%;
      height: 100px;
      background: linear-gradient(to top, #1c0f22, transparent);
      z-index: 100;
    }
...
.info {
  ...
  .infoImage {
    ...
    &::before {
      ...
      width: 100%;
      height: 150px;
      background: linear-gradient(to bottom, #1c0f22, transparent);
      z-index: 100;
    }
...
.morphing-5 {
  ...
  box-shadow:0 0 0px 80px darken($color: $textColor, $amount: 0%);
  background: lighten($color: $textColor, $amount: 0%);
  ...
  &:hover {
    color:$backgroundColor;
    transition: 0.3s,clip-path 0.2s 0.2s; 
